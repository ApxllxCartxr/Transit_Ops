...
class ReportService:
    """
    Fleet analytics/report service from BE2 (feat/backend-ops-analytics).
    Handles edge cases: zero vehicles, all retired, zero acquisition cost.
    """
    ...
    def build_report(
        ...
        if (retired_count >= vehicle_count and vehicle_count > 0) or acquisition_cost <= 0:
            vehicle_roi = "N/A"
        else:
